...
extract($_POST);
if(isset($id)){
	$qry = $conn->query("SELECT * FROM payments where loan_id=".$loan_id);

}
$loan = $conn->query("SELECT l.*,concat(b.firstname,', ',b.middlename,' ',b.lastname)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id where l.id = ".$loan_id);
...
<div class="row">
	...
	<div class="col-md-5">
		<div class="form-group">
			...
			<input type="number" name="amount" step="any" min="1000"  class="form-control text-right"  value="<?php echo isset($amount) ? $amount : '' ?>"required>
