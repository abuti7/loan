				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<textarea name="type_name" id="" cols="30" rows="2" required class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Description</label>
								<textarea name="description" id="" cols="30" rows="2" required class="form-control"></textarea>
							</div>
